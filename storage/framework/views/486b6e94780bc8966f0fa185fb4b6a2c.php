...
<?php $__env->startSection('title', 'Edit Ruangan - ' . $room->name); ?>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                ...
                <p class="lead mb-0"><?php echo e($room->name); ?></p>
            </div>
            <div class="col-auto">
                <div class="btn-group" role="group">
                    <a href="<?php echo e(route('rooms.show', $room->id)); ?>" class="btn btn-light">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('rooms.update', $room->id)); ?>" method="POST" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      name="description" 
                                      rows="3"
                                      placeholder="Tambahan informasi tentang ruangan (kapasitas, fungsi, dsb)"><?php echo e(old('description', $room->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('rooms.show', $room->id)); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><?php echo e($room->created_at->format('d M Y, H:i')); ?></p>
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><?php echo e($room->updated_at->format('d M Y, H:i')); ?></p>
                            <small class="text-muted"><?php echo e($room->updated_at->diffForHumans()); ?></small>
                        </div>
                    </div>
                </div>
            </div>
